...
class MyApp extends StatelessWidget {
  ...
  MyApp({super.key}) {
    biodata['name'] = 'Alexander Steven Marselinus';
    biodata['email'] = 'lostiven89@gmail.com';
    biodata['phone'] = '089521573598';
    biodata['image'] =
    ...
    biodata['hobby'] = 'Berenang dan Baca Komik';
    biodata['address'] = 'Kabupaten Bandung Jawa Barat';
    biodata['desc'] =
      ...
      home: Scaffold(
          ...
          body: Center(
            ...
            children: [
              ...
              Image(image: NetworkImage(biodata['image'] ?? '')),
  ...
  Expanded btnProfile(Color btnColor, IconData btnIcon, String uri) {
    return Expanded(
